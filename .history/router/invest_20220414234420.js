...
router.get('/getFundInvest', (req, res) => {
  handler.exec({
    sql: `SELECT fundinvest.fundCode,fundinvest.buyTime,fundinvest.buyPrice,fundinvest.prePrice,fundinvest.share,fundinvest.accountName,fundlist.name,fundlist.currentPrice FROM fundinvest LEFT JOIN fundlist 
